define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'comment/commentlibrary/index',
                    add_url: 'comment/commentlibrary/add',
                    edit_url: 'comment/commentlibrary/edit',
                    del_url: 'comment/commentlibrary/del',
                    multi_url: 'comment/commentlibrary/multi',
                    table: 'comment_library',
                }
            });
